...
## [Legal Docs Branch]() XXXX-XX-XX

### Added
* Rule Display to Code Editor
* Known Rules Drawer
* Override Block
* Can specify Akoma Ntoso when creating Rule
* Akoma Ntoso Example Rule

### Changed
* Rules are now primary objects in the database
* Workspaces are specific to a section of a rule
