...
},
{
  ...
  "colour": 165,
  "tooltip": "Used to set out a named agenda",
  "helpUrl": "/docs/blocks/agenda"
},
{
  "type": "agenda_question",
  "message0": "Ask for between %1 and %2 %3 answers to the question %4 %5",
  "args0": [
    {
      "type": "field_number",
      "name": "min",
  ...
  "previousStatement": "AGENDA_STEP",
  "nextStatement": "AGENDA_STEP",
  "colour": 165,
  "tooltip": "Creates an agenda step in which a question is posed a number of times.",
  "helpUrl": "/docs/blocks/agenda_question"
},
{
  "type": "agenda_question_with_loop",
  "message0": "Ask for between %1 and %2 %3 answers to the question %4 %5 and immediately after each... %6 %7",
  "args0": [
    {
      "type": "field_number",
      "name": "min",
  ...
  "nextStatement": "AGENDA_STEP",
  "colour": 165,
  "tooltip": "Used to ask a question and then a set of question about the answer.",
  "helpUrl": "/docs/blocks/agenda_question_with_loop"
},
{
  "type": "agenda_loop",
  "message0": "For each answer to %1 %2 do %3 %4",
  "args0": [
    {
      "type": "input_dummy"
    },
  ...
  "nextStatement": "AGENDA_STEP",
  "colour": 165,
  "tooltip": "Use to ask questions for each answer already received.",
  "helpUrl": "/docs/blocks/agenda_loop"
},
{
  "type": "agenda_phase",
  "message0": "Phase: %1 %2 %3",
  "args0": [
    {
      "type": "field_input",
      "name": "phase_name",
  ...
  "nextStatement": "AGENDA_STEP",
  "colour": 165,
  "tooltip": "Use to set out a phase that can be used in the interface.",
...
Blockly.Blocks['relationship_declaration'] = {
  init: function() {
    ...
    for (var a=1; a< 3+1; a++) {
      ...
      desc.appendField(new Blockly.FieldDropdown([["number","number"], ["date","date"], ["time","time"], ["datetime","datetime"], ["duration","duration"], ['list','list']]), "type" + a);
    }
...
function updateLocalCategories() {
  ...
  for (var i=0; i< rel_blocks.length; i++) {
    var arity = parseInt(rel_blocks[i].getFieldValue('relationship_arity'));
