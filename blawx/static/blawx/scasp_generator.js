...
// blawx_as_of(recommended_dose(A,B,C),datetime(Time)) :-
//     blawx_becomes(recommended_dose(A,B,C),datetime(BeforeT)),
//     not blawx_interrupted(datetime(BeforeT),recommended_dose(A,B,C),datetime(Time)),
//     BeforeT #< Time.
    code += 'blawx_as_of(' + text_relationship_name + '(' + parameters + '),datetime(Time)) :- blawx_initially(' + text_relationship_name + '(' + parameters + ')),, BeforeT #< Time,blawx_not_interrupted(' + text_relationship_name + '(' + parameters + '),datetime(BeforeT)).\n'
    ...
    code += 'blawx_not_interrupted(' + text_relationship_name + '(' + parameters + '),datetime(End)) :- findall(Time,blawx_becomes(-' + text_relationship_name + '(' + parameters + '),datetime(Time)),Times),blawx_list_not_between(Times,0,End).\n';
    code += 'blawx_not_interrupted(-' + text_relationship_name + '(' + parameters + '),datetime(End)) :- findall(Time,blawx_becomes(' + text_relationship_name + '(' + parameters + '),datetime(Time)),Times),blawx_list_not_between(Times,0,End).\n';
    code += 'blawx_not_interrupted(datetime(Start),' + text_relationship_name + '(' + parameters + '),datetime(End)) :- findall(Time,blawx_becomes(-' + text_relationship_name + '(' + parameters + '),datetime(Time)),Times),blawx_list_not_between(Times,Start,End).\n'
    code += 'blawx_not_interrupted(datetime(Start),-' + text_relationship_name + '(' + parameters + '),datetime(End)) :- findall(Time,blawx_becomes(' + text_relationship_name + '(' + parameters + '),datetime(Time)),Times),blawx_list_not_between(Times,Start,End).\n'
    code += 'blawx_as_of(' + text_relationship_name + '(' + parameters + '),datetime(Time)) :- blawx_initially(-' + text_relationship_name + '(' + parameters + ')),, BeforeT #< Time,blawx_not_interrupted(-' + text_relationship_name + '(' + parameters + '),datetime(BeforeT)).\n'
    code += 'blawx_as_of(-' + text_relationship_name + '(' + parameters + '),datetime(Time)) :- blawx_becomes(-' + text_relationship_name + '(' + parameters + '),datetime(BeforeT)),BeforeT #< Time,blawx_not_interrupted(datetime(BeforeT),-' + text_relationship_name + '(' + parameters + '),datetime(Time)).\n'
