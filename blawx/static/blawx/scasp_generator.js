...
sCASP['new_attribute_declaration'] = function(block) {
    ...
    if (dropdown_attribute_type != "boolean") {
        ...
        code += 'blawx_as_of(' + text_attribute_name + '(X,Y),timestamp(Time)) :- blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(BeforeT)), not blawx_becomes(-' + text_attribute_name + '(X,Y), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
        code += 'blawx_as_of(' + text_attribute_name + '(X,Y),timestamp(Time)) :- blawx_initially(' + text_attribute_name + '(X,Y)), not blawx_becomes(-' + text_attribute_name + '(X,Y), timestamp(BetweenT)), BetweenT #< Time.\n';
        code += 'blawx_during(timestamp(Start),' + text_attribute_name + '(X,Y),timestamp(End)) :- blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(Start)), not blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(BeforeEnd)), blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
        code += 'blawx_during(timestamp(bot),' + text_attribute_name + '(X,Y),timestamp(End)) :- blawx_initially(' + text_attribute_name + '(X,Y)), not blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(BeforeEnd)), blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(End)), BeforeEnd #< End.\n';
        code += 'blawx_during(timestamp(Start),' + text_attribute_name + '(X,Y),timestamp(eot)) :- blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(Start)), not blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(AfterStart)), blawx_ultimately(' + text_attribute_name + '(X,Y)), AfterStart #> Start.\n';
        code += 'blawx_as_of(-' + text_attribute_name + '(X,Y),timestamp(Time)) :- blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(BeforeT)), not blawx_becomes(' + text_attribute_name + '(X,Y), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
        code += 'blawx_as_of(-' + text_attribute_name + '(X,Y),timestamp(Time)) :- blawx_initially(-' + text_attribute_name + '(X,Y)), not blawx_becomes(' + text_attribute_name + '(X,Y), timestamp(BetweenT)), BetweenT #< Time.\n';
        code += 'blawx_during(timestamp(Start),-' + text_attribute_name + '(X,Y),timestamp(End)) :- blawx_becomes(-' + text_attribute_name + '(X,Y),timestamp(Start)), not blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(BeforeEnd)), blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
        code += 'blawx_during(timestamp(bot),-' + text_attribute_name + '(X,Y),timestamp(End)) :- blawx_initially(-' + text_attribute_name + '(X,Y)), not blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(BeforeEnd)), blawx_becomes(' + text_attribute_name + '(X,Y),timestamp(End)), BeforeEnd #< End.\n';
        ...
        code += 'blawx_as_of(' + text_attribute_name + '(X),timestamp(Time)) :- blawx_becomes(' + text_attribute_name + '(X),timestamp(BeforeT)), not blawx_becomes(-' + text_attribute_name + '(X), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
        code += 'blawx_as_of(' + text_attribute_name + '(X),timestamp(Time)) :- blawx_initially(' + text_attribute_name + '(X)), not blawx_becomes(-' + text_attribute_name + '(X), timestamp(BetweenT)), BetweenT #< Time.\n';
        code += 'blawx_during(timestamp(Start),' + text_attribute_name + '(X),timestamp(End)) :- blawx_becomes(' + text_attribute_name + '(X),timestamp(Start)), not blawx_becomes(-' + text_attribute_name + '(X),timestamp(BeforeEnd)), blawx_becomes(-' + text_attribute_name + '(X),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
        code += 'blawx_during(timestamp(bot),' + text_attribute_name + '(X),timestamp(End)) :- blawx_initially(' + text_attribute_name + '(X)), not blawx_becomes(-' + text_attribute_name + '(X),timestamp(BeforeEnd)), blawx_becomes(-' + text_attribute_name + '(X),timestamp(End)), BeforeEnd #< End.\n';
        code += 'blawx_during(timestamp(Start),' + text_attribute_name + '(X),timestamp(eot)) :- blawx_becomes(' + text_attribute_name + '(X),timestamp(Start)), not blawx_becomes(-' + text_attribute_name + '(X),timestamp(AfterStart)), blawx_ultimately(' + text_attribute_name + '(X)), AfterStart #> Start.\n';
        code += 'blawx_as_of(-' + text_attribute_name + '(X),timestamp(Time)) :- blawx_becomes(-' + text_attribute_name + '(X),timestamp(BeforeT)), not blawx_becomes(' + text_attribute_name + '(X), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
        code += 'blawx_as_of(-' + text_attribute_name + '(X),timestamp(Time)) :- blawx_initially(-' + text_attribute_name + '(X)), not blawx_becomes(' + text_attribute_name + '(X), timestamp(BetweenT)), BetweenT #< Time.\n';
        code += 'blawx_during(timestamp(Start),-' + text_attribute_name + '(X),timestamp(End)) :- blawx_becomes(-' + text_attribute_name + '(X),timestamp(Start)), not blawx_becomes(' + text_attribute_name + '(X),timestamp(BeforeEnd)), blawx_becomes(' + text_attribute_name + '(X),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
        code += 'blawx_during(timestamp(bot),-' + text_attribute_name + '(X),timestamp(End)) :- blawx_initially(-' + text_attribute_name + '(X)), not blawx_becomes(' + text_attribute_name + '(X),timestamp(BeforeEnd)), blawx_becomes(' + text_attribute_name + '(X),timestamp(End)), BeforeEnd #< End.\n';
...
sCASP['new_category_declaration'] = function(block) {
    ...
    code += 'blawx_as_of(' + text_category_name + '(X),timestamp(Time)) :- blawx_becomes(' + text_category_name + '(X),timestamp(BeforeT)), not blawx_becomes(-' + text_category_name + '(X), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
    code += 'blawx_as_of(' + text_category_name + '(X),timestamp(Time)) :- blawx_initially(' + text_category_name + '(X)), not blawx_becomes(-' + text_category_name + '(X), timestamp(BetweenT)), BetweenT #< Time.\n';
    code += 'blawx_during(timestamp(Start),' + text_category_name + '(X),timestamp(End)) :- blawx_becomes(' + text_category_name + '(X),timestamp(Start)), not blawx_becomes(-' + text_category_name + '(X),timestamp(BeforeEnd)), blawx_becomes(-' + text_category_name + '(X),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
    code += 'blawx_during(timestamp(bot),' + text_category_name + '(X),timestamp(End)) :- blawx_initially(' + text_category_name + '(X)), not blawx_becomes(-' + text_category_name + '(X),timestamp(BeforeEnd)), blawx_becomes(-' + text_category_name + '(X),timestamp(End)), BeforeEnd #< End.\n';
    code += 'blawx_during(timestamp(Start),' + text_category_name + '(X),timestamp(eot)) :- blawx_becomes(' + text_category_name + '(X),timestamp(Start)), not blawx_becomes(-' + text_category_name + '(X),timestamp(AfterStart)), blawx_ultimately(' + text_category_name + '(X)), AfterStart #> Start.\n';
    code += 'blawx_as_of(-' + text_category_name + '(X),timestamp(Time)) :- blawx_becomes(-' + text_category_name + '(X),timestamp(BeforeT)), not blawx_becomes(' + text_category_name + '(X), timestamp(BetweenT)), BeforeT #< Time,BeforeT #< BetweenT, BetweenT #< Time.\n';
    code += 'blawx_as_of(-' + text_category_name + '(X),timestamp(Time)) :- blawx_initially(-' + text_category_name + '(X)), not blawx_becomes(' + text_category_name + '(X), timestamp(BetweenT)), BetweenT #< Time.\n';
    code += 'blawx_during(timestamp(Start),-' + text_category_name + '(X),timestamp(End)) :- blawx_becomes(-' + text_category_name + '(X),timestamp(Start)), not blawx_becomes(' + text_category_name + '(X),timestamp(BeforeEnd)), blawx_becomes(' + text_category_name + '(X),timestamp(End)), BeforeEnd #< End, Start #< End.\n';
    code += 'blawx_during(timestamp(bot),-' + text_category_name + '(X),timestamp(End)) :- blawx_initially(-' + text_category_name + '(X)), not blawx_becomes(' + text_category_name + '(X),timestamp(BeforeEnd)), blawx_becomes(' + text_category_name + '(X),timestamp(End)), BeforeEnd #< End.\n';
